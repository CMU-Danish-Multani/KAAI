...
|---|---|---|---|
| **Ω\_m** (omega-m) | How much **stuff** the universe contains | 0.1 – 0.5 | ▷ The fraction of the total energy density of the universe made up of matter (dark + normal). If Ω\_m is 1, the universe is matter-dominated and flat. |
| **σ\_8** (sigma-8) | How **lumpy** it started out | 0.6 – 1.0 | ▷ A measure of how much matter has clumped together at a specific scale (8 Mpc/h). Quantifies the amplitude of matter fluctuations. |
...
| `edge_attr` | How many time-steps an arrow skips (2–70, because blobs were deleted) |
