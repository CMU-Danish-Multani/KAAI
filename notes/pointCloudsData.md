...
| Clouds (val) | 200 | 204 |
| Galaxies per cloud | **762 to 4,511** (varies) | **exactly 5,000** |
...
![slices](../point_clouds/plots/07_cloud_slices.png)
...
![camels-sam omega](../point_clouds/plots/09_camelssam_omega.png)
...
![clustering](../point_clouds/plots/08_clustering.png)
